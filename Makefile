...
docker-build:
	docker build -t jamesgu/art-portfolio:2018_05_01_0330 .

docker-push:
	docker push jamesgu/art-portfolio:2018_05_01_0330

docker-run:
	docker run -d --name art-portfolio -p 80:8000 jamesgu/art-portfolio:2018_05_01_0330
